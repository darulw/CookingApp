package com.example.cookingapp.sampleRecipes;
...
public class RecipeListFragment extends Fragment {
    ...
    private void UpdateUI() {
        ...
        List<Recipe> recipes = recipeSingleton.getSampleRecipes();
    ...
    private class RecipeHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Recipe recipe){
           ...
           mImageView.setImageResource(recipe.getSampleImage());
        }
    }
        ...
        public RecipeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    int x = mRecyclerView.getChildAdapterPosition(view);
                    Toast.makeText(getContext(), "Recipe nr" +x, Toast.LENGTH_SHORT).show();
                }
            });
